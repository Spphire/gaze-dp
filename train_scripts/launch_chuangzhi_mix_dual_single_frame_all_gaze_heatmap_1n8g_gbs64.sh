...
export TASK_NAME="mix_dual_shared_vit_all_gaze_heatmap_temporal_mixed_nll_1n8g_gbs64"
export CONFIG_NAME="train_gaze_wam_chuangzhi_mix_dual_single_frame_all_gaze_heatmap_1n8g_gbs64"
export ACCELERATE_CONFIG="accelerate/8gpu-amp.yaml"
export EXPECTED_NNODES=1
export EXPECTED_NPROC_PER_NODE=8
export RESUME=false
export INIT_CHECKPOINT="${INIT_CHECKPOINT:-data/outputs/chuangzhi/mix_dual_shared_vit_temporal_mixed_nll_1n8g_gbs64/job-0bc4dab9-08f0-4540-aa4f-8b9855be740d-worker-0_23456/checkpoints/latest.ckpt}"
