...
export TASK_NAME="chuangzhi_mix_dual_single_frame_all_gaze_latent_1n8g_gbs64"
export CONFIG_NAME="train_gaze_wam_chuangzhi_mix_dual_single_frame_all_gaze_1n8g_gbs64"
