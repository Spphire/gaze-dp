...
export TASK_NAME="chuangzhi_robot_wrist_single_frame_always_gaze_latent_1n8g_gbs64"
export CONFIG_NAME="train_gaze_wam_chuangzhi_robot_wrist_single_frame_always_gaze_1n8g_gbs64"
