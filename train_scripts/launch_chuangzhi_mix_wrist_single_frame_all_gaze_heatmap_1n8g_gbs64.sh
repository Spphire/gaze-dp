...
export TASK_NAME="mix_wrist_single_frame_all_gaze_heatmap_temporal_mixed_nll_1n8g_gbs64"
export CONFIG_NAME="train_gaze_wam_chuangzhi_mix_wrist_single_frame_all_gaze_heatmap_1n8g_gbs64"
